...
2. **Create a new branch** for your changes: `git checkout -b add/your-resource-name`
3. **Make your changes** following the guidelines below.
4. **Commit** your changes: `git commit -m "Add [resource name]"`
5. **Push** to your fork: `git push origin add/your-resource-name`
...
- Add your resource to the **most relevant section** of `Readme.md`.
- Use the following format:
  ```
  - [Resource Name](https://link-to-resource) – Short description of what it does.
  ```
- The description should be **concise** (one sentence) and start with a capital letter.
